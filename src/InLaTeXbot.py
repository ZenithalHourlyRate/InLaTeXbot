...
class InLaTeXbot():
    ...
    def __init__(self, updater, devnullChatId=-1):
        ...
        self._updater.dispatcher.add_handler(CommandHandler('latex', self.onLatex))
    ...
    def onLatex(self, update, context):
        self._messageQueryResponseDispatcher.dispatchMessageQueryResponse(update.message, context)
        raise DispatcherHandlerStop
